...
if(isset($_GET['act']) && ($_GET['act']== "add")){
	...
	$qdata = mysqli_query($connect_db,"select * from mst_blog where idmenu=$idkey")
	...
	$qinsert = mysqli_query($connect_db, 
			"INSERT into mst_blog(judul,id_kategori,isi,author,date_input) VALUES('$nmjudul','$kategori',$isi, $author, $datein)")
			or die (mysqli_error($connect_db));
	if($qinsert){
		//ketik proses simpan berhasil
		header("Location: http://localhost/backup/latihan_webphp-main/admin/home.php?modul=mod_blog");
	}
}
